...
- Introduce `CompositionHooks` with six lifecycle interception points (before_context_build, after_context_build, before_tool_policy, after_tool_result, prepare_next_turn, on_event) and hook outcome chaining via `ComposedCompositionHooks`.
